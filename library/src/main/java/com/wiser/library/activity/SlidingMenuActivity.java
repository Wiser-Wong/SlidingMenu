package com.wiser.library.activity;
 ...
 * @version 版本
 */
public class SlidingMenuActivity extends FragmentActivity implements ISlidingMenuActivity {

	private SlidingMenuHelper mHelper;
